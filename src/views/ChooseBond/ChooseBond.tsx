...
const ChooseBond: React.FC<Props>=({popup, setPopup})=> {
              ...
              <TableBody>
                {bonds.map((bond) => {
                  ...
                  if (
                    ...
                    return <BondTableData popup={popup} setPopup={setPopup} key={bond.name} bond={bond} />;
                  }
                })}
              </TableBody>
            </Table>
              ...
              if (
                ...
                return (
                  <Grid item xs={12} key={bond.name}>
                    <BondDataCard popup={popup} setPopup={setPopup}  key={bond.name} bond={bond} />
                  </Grid>
                );
              }
            })}
