...
export function BondDataCard({ bond, popup, setPopup }) {
    ...
    <Slide direction="up" in={true}>
      <Paper id={`${bond.name}--bond`} className="bond-data-card ohm-card">
        ...
        {/* <Link component={NavLink} to={`/mints/${bond.name}`}>
         ...
         <Button variant="outlined" color="primary" fullWidth disabled={!bond.isBondable[networkId]} onClick={()=>setPopup(!popup)}>
